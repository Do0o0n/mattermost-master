...
export function applyTheme(theme: Theme) {
    ...
    if (theme.linkColor) {
        ...
        changeCss('.app__body .channel-header .channel-header__favorites.inactive:hover, .app__body a, .app__body a:focus, .app__body a:hover, .app__body .color--link, .app__body a:focus, .app__body .color--link:hover', 'color:');
        ...
        changeCss('.app__body .post .post-collapse__show-more-button:hover', `background-color:${'#00987e'}`);
    }
...
export function getDatePickerLocalesForDateFns(locale: string, loadedLocales: Record<string, Locale>) {
    if (locale && locale !== 'ar' && !loadedLocales[locale]) {
        try {
