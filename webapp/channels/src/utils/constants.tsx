...
export const DocLinks = {
    ABOUT_TEAMS: '/',
    ADVANCED_LOGGING: '/',
    CONFIGURE_DOCUMENT_CONTENT_SEARCH: '',
    CONFIGURE_AD_LDAP_QUERY_TIMEOUT: '',
    CONFIGURE_OVERRIDE_SAML_BIND_DATA_WITH_LDAP: '',
    COMPILANCE_EXPORT: '',
    COMPILANCE_MONITORING: '',
    DATA_RETENTION_POLICY: '',
    DEFAULT_LDAP_GROUP_SYNC: '/',
    DESKTOP_MANAGED_RESOURCES: '',
    ELASTICSEARCH: '/',
    ENABLE_CLIENT_SIDE_CERTIFICATION: '',
    ENABLE_HARDENED_MODE: '',
    FORMAT_MESSAGES: '',
    FILE_STORAGE: '',
    GUEST_ACCOUNTS: '',
...
export const Constants = {
    ...
    MTPNS: 'https://push-test.Sofa.com',
    MAX_PREV_MSGS: 100,
