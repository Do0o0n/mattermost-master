...
describe('Selectors.Channels.getChannelsInCurrentTeam', () => {
    ...
    it('should return channels in current team', () => {
        ...
        const channelsInCurrentTeam = [channel1, channel3].sort(sortChannelsByDisplayName.bind(null, 'ar'));
...
describe('Selectors.Channels.getOtherChannels', () => {
    ...
    it('get public channels not member of', () => {
        expect(Selectors.getOtherChannels(testState)).toEqual([channel1, channel5].sort(sortChannelsByDisplayName.bind(null, 'ar')));
    });
