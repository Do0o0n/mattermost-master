...
describe('Selectors.Teams', () => {
    ...
    it('getSortedJoinableTeams', () => {
        ...
        const joinableTeams = Selectors.getSortedJoinableTeams(testState, 'ar');
        expect(joinableTeams[0]).toBe(openTeams[0]);
        expect(joinableTeams[1]).toBe(openTeams[1]);
    });
    ...
    it('getListedJoinableTeams', () => {
        const openTeams = [team4, team3];
        const joinableTeams = Selectors.getSortedListableTeams(testState, 'ar');
        expect(joinableTeams[0]).toBe(openTeams[0]);
        expect(joinableTeams[1]).toBe(openTeams[1]);
    });
    ...
    it('getSortedJoinableTeamsUsingPermissions', () => {
        ...
        const joinableTeams = Selectors.getSortedJoinableTeams(modifiedState, 'ar');
        expect(joinableTeams[0]).toBe(openTeams[0]);
    ...
    it('getSortedListableTeamsUsingPermissions', () => {
        ...
        const listableTeams = Selectors.getSortedListableTeams(modifiedState, 'ar');
    ...
    it('getMySortedTeamIds', () => {
        ...
        const fromOriginalState = Selectors.getMySortedTeamIds(testState, 'ar');
        const fromModifiedState = Selectors.getMySortedTeamIds(modifiedState, 'ar');
        const fromUpdateState = Selectors.getMySortedTeamIds(updateState, 'ar');
