...
describe('makeSortChannelsByName', () => {
    const currentUser = {id: 'currentUser', locale: 'ar'};
...
describe('makeSortChannelsByNameWithDMs', () => {
    const currentUser = {id: 'currentUser', username: 'currentUser', first_name: 'Current', last_name: 'User', locale: 'ar'};
    const otherUser1 = {id: 'otherUser1', username: 'otherUser1', first_name: 'Other', last_name: 'User', locale: 'ar'};
    const otherUser2 = {id: 'otherUser2', username: 'otherUser2', first_name: 'Another', last_name: 'User', locale: 'ar'};
...
describe('makeGetChannelIdsForCategory', () => {
    ...
    test('should return sorted and filtered channels for direct messages category with recency sorting', () => {
        ...
        const otherUser3 = {id: 'otherUser3', username: 'otherUser3', first_name: 'Third', last_name: 'User', locale: 'ar'};
