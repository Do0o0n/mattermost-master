...
describe('ChannelUtils', () => {
    ...
    it('sortChannelsByDisplayName', () => {
        ...
        expect(sortChannelsByDisplayName('ar', channelA, channelB)).toBe(-1);
        expect(sortChannelsByDisplayName('ar', channelB, channelA)).toBe(1);
    ...
    it('sortChannelsByTypeListAndDisplayName', () => {
        ...
        let sortfn = sortChannelsByTypeListAndDisplayName.bind(null, 'ar', [General.OPEN_CHANNEL, General.PRIVATE_CHANNEL, General.DM_CHANNEL, General.GM_CHANNEL]);
        ...
        sortfn = sortChannelsByTypeListAndDisplayName.bind(null, 'ar', [General.DM_CHANNEL, General.GM_CHANNEL, General.PRIVATE_CHANNEL]);
