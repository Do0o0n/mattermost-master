...
function ResizableDivider({
    ...
    const isRtl = document.documentElement.dir === 'rtl'; // تحديد اتجاه الصفحة
    ...
    useEffect(() => {
        ...
        const onMouseMove = (e: MouseEvent) => {
            ...
            case ResizeDirection.LEFT:
                widthDiff = isRtl ? previousClientX.current - e.clientX : e.clientX - previousClientX.current;
                break;
            case ResizeDirection.RIGHT:
                widthDiff = isRtl ? e.clientX - previousClientX.current : previousClientX.current - e.clientX;
                break;
            }
        ...
        <>
            <Divider
                ...
                className={classNames(className, {
                    left: (dir === ResizeDirection.LEFT && !isRtl) || (dir === ResizeDirection.RIGHT && isRtl),
                    right: (dir === ResizeDirection.RIGHT && !isRtl) || (dir === ResizeDirection.LEFT && isRtl),
                })}
                ref={resizeLineRef}
                isActive={isActive}
