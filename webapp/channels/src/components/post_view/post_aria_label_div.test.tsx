...
import enMessages from 'i18n/ar.json';
...
describe('PostAriaLabelDiv', () => {
    ...
    test('should render aria-label in the given locale', () => {
        ...
        (reactIntl.useIntl as jest.Mock).mockImplementation(() => reactIntl.createIntl({locale: 'ar', messages: enMessages, defaultLocale: 'ar'}));
