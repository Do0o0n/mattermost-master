...
import SidebarCategory1 from './SidebarChannelItem';
...
// Export SidebarCategory component
export const ConnectedSidebarCategory = connect(makeMapStateToProps, mapDispatchToProps)(SidebarCategory);

// Export SidebarCategory1 component
export const ConnectedSidebarCategory1 = connect(makeMapStateToProps, mapDispatchToProps)(SidebarCategory1);
