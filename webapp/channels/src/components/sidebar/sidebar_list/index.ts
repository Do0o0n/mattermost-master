...
import SidebarList1 from './sidebar_list1';
...
// Export SidebarList component
export const ConnectedSidebarList = connect(mapStateToProps, mapDispatchToProps)(SidebarList);

// Export SidebarList1 component
export const ConnectedSidebarList1 = connect(mapStateToProps, mapDispatchToProps)(SidebarList1);
