                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            help_text: defineMessage({id: 'admin.team.restrictDescription', defaultMessage: 'New user accounts are restricted to the above specified email domain (e.g. "mattermost.com") or list of comma-separated domains (e.g. "corp.sofa.com, sofa.com"). New teams can only be created by users from the above domain(s). This setting only affects email login for users.'}),
                            placeholder: defineMessage({id: 'admin.team.restrictExample', defaultMessage: 'E.g.: "corp.sofa.com, sofa.com"'}),
                            isHidden: it.all(
                                it.licensed,
