...
export default class LogList extends React.PureComponent<Props, State> {
    ...
    getColumns = (dateAsc: boolean): Column[] => {
        ...
        // Check the HTML's 'dir' attribute and set textAlign accordingly
        const textAlign = document.documentElement.dir === 'rtl' ? 'right' : 'left';
    ...
    render = (): JSX.Element => {
        ...
        const errorsButton: JSX.Element = (
            <button
                className='btn btn-tertiary btn-sm ml-2 btntertiary'
