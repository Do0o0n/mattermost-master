...
describe('components/admin_console/license_settings/enterprise_edition/enterprise_edition_left_panel', () => {
    ...
    test('should not add any class if active users is lower than the minimal', () => {
        ...
        expect(screen.getByText(Intl.NumberFormat('ar').format(baseProps.statsActiveUsers))).toHaveClass('value');
        expect(screen.getByText(Intl.NumberFormat('ar').format(baseProps.statsActiveUsers))).not.toHaveClass('value--warning-over-seats-purchased');
        expect(screen.getByText(Intl.NumberFormat('ar').format(baseProps.statsActiveUsers))).not.toHaveClass('value--over-seats-purchased');
    ...
    test('should add warning class to active users', () => {
        ...
        expect(screen.getByText(Intl.NumberFormat('ar').format(minWarning))).toHaveClass('value');
        expect(screen.getByText(Intl.NumberFormat('ar').format(minWarning))).toHaveClass('value--warning-over-seats-purchased');
        expect(screen.getByText(Intl.NumberFormat('ar').format(minWarning))).not.toHaveClass('value--over-seats-purchased');
        expect(screen.getByText('ACTIVE USERS:')).toHaveClass('legend');
    ...
    test('should add over-seats-purchased class to active users', () => {
        ...
        expect(screen.getByText(Intl.NumberFormat('ar').format(exceedHighLimitExtraUsersError))).toHaveClass('value');
        expect(screen.getByText(Intl.NumberFormat('ar').format(exceedHighLimitExtraUsersError))).toHaveClass('value--over-seats-purchased');
        expect(screen.getByText(Intl.NumberFormat('ar').format(exceedHighLimitExtraUsersError))).not.toHaveClass('value--warning-over-seats-purchased');
        expect(screen.getByText('ACTIVE USERS:')).toHaveClass('legend');
        expect(screen.getByText('ACTIVE USERS:')).not.toHaveClass('legend--warning-over-seats-purchased');
