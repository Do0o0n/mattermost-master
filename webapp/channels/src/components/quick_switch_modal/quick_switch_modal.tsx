...
export default class QuickSwitchModal extends React.PureComponent<Props, State> {
    ...
    public render = (): JSX.Element => {
        ...
        return (
            <Modal
                dialogClassName='a11y__modal channel-switcher modal-conten'
                show={true}
            ...
            >
                <Modal.Header
                    className='modal-header  Groups_hader'
                    id='quickSwitchModalLabel'
                    closeButton={true}
                >
                    <div
                        className='channel-switcher__header headerrr'
                        id='quickSwitchHeaderWithHint'
                    >
                        {header}
                        <div
                            className='channel-switcher__hint headerrr'
                            id='quickSwitchHint'
                        >
                            {help}
                        </div>
