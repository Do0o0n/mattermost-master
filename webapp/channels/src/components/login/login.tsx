...
const Login = ({onCustomizeHeader}: LoginProps) => {
    ...
    const getCardTitle = () => {
        ...
        if (!enableBaseLogin && enableExternalSignup) {
            return formatMessage({id: 'login.cardtitle.external', defaultMessage: 'Login with one of the following:'});
        }

        return formatMessage({id: 'login.cardtitle', defaultMessage: 'Login'});
    };
