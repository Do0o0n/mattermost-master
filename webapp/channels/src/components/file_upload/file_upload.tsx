...
const customStyles = (direction: string) => ({
    left: direction === 'rtl' ? 0 : 'inherit',
    right: direction === 'rtl' ? 'inherit' : 0,
    bottom: '100%',
    top: 'auto',
    ':global(html[dir="ltr"]) &': {
        padding: '0 20px',
...
class FileUpload extends PureComponent<Props, State> {
    ...
    render() {
        ...
        const direction = document.documentElement.dir || 'ltr'; // Get direction from the document

        const styles = customStyles(direction);
        ...
        if (this.props.pluginFileUploadMethods.length === 0) {
            bodyAction = (
                <div>
                    ...
                    <input
                        id='fileUploadInput'
                        tabIndex={-1}
                        aria-label={intl.formatMessage(holders.uploadFile)}
                        ref={this.fileInput}
                        type='file'
            ...
            const pluginFileUploadMethods = this.props.pluginFileUploadMethods.
                filter((item) => item.pluginId !== 'voice'). // يستبعد العناصر غير المرغوب فيها هنا
                map((item) => (
                    <li
                    ...
                    <MenuWrapper>
                        ...
                        >
                            <button
                                ...
                                id='fileUploadButton'
                                aria-label={buttonAriaLabel}
                                className='style--none AdvancedTextEditor__action-button colorsvg'
                            >
                                <PaperclipIcon
                        ...
                        <div className='nono'>
                            <Menu
                                ...
                                openLeft={true}
                                openUp={true}
                                ariaLabel={intl.formatMessage({id: 'file_upload.menuAriaLabel', defaultMessage: 'Upload type selector'})}
                                customStyles={styles}
                            >
                                <li>
                                    <a
                                        ...
                                        <span className='mr-2'>
                                            <div className='icon'>
                                                <svg
                                                    ...
                                                    height='16'
                                                    viewBox='0 0 16 16'
                                                    fill='var(--sidebar-header-bg) !important'
                                                    xmlns='http://www.w3.org/2000/svg'
                                                >
                                                    <path
                                                        d='M13 9.5V7.75C13 6.50736 11.9926 5.5 10.75 5.5H9.75C9.33579 5.5 9 5.16421 9 4.75V3.75C9 2.50736 7.99264 1.5 6.75 1.5H5.5M10 9.5L8 7.5M8 7.5L6 9.5M8 7.5L8 11.5M7 1.5H3.75C3.33579 1.5 3 1.83579 3 2.25V13.75C3 14.1642 3.33579 14.5 3.75 14.5H12.25C12.6642 14.5 13 14.1642 13 13.75V7.5C13 4.18629 10.3137 1.5 7 1.5Z'
                                                        stroke='currentcolor'
                                                        strokeLinecap='round'
...
export default injectIntl(FileUpload, {forwardRef: true});
