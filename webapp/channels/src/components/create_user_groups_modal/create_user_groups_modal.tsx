...
export class CreateUserGroupsModal extends React.PureComponent<Props, State> {
    ...
    render() {
        const isRTL = document.documentElement.dir === 'rtl'; // التحقق مما إذا كانت الصفحة RTL
        return (
            <Modal
                dialogClassName='a11y__modal user-groups-modal-create  modal-conten'
                ...
                <Modal.Body>
                    <div className='user-groups-modal__content'>
                        <div className='group-name-input-wrapper'>
                            <Input
                                type='text'
                                placeholder={Utils.localizeMessage('user_groups_modal.name', isRTL ? 'الاسم' : 'Name')}
