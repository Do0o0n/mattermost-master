        ...
        >
            ...
            <div className='suggestion-list__ellipsis suggestion-list__flex'>
                <span className='suggestion-list__main'>
                    ...
                    {showSlug && description && <span className='ml-2 suggestion-list__desc'>{''}</span>}
                </span>
                {customStatus}
                {sharedIcon}
                {tag}
...
function sortChannelsByRecencyAndTypeAndDisplayName(wrappedA: WrappedChannel, wrappedB: WrappedChannel) {
    ...
    return sortChannelsByTypeAndDisplayName('ar', wrappedA.channel as Channel, wrappedB.channel as Channel);
}
